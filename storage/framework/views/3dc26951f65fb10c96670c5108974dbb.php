      ...
      <form>
        ...
        <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
          <div class="relative w-full">
            ...
            <input type="search" id="search" name="search" autocomplete="off" placeholder="Search for article" 
          ...
          <div class="flex justify-between items-center">
            <a href="/posts?author=<?php echo e($post->author->username); ?>">
              <div class="flex items-center space-x-3">
                ...
                <span class="font-medium text-sm dark:text-white"><?php echo e($post->author->name); ?></span>
              </div>
            </a>
...
<?php endif; ?>
<?php /**PATH C:\Users\BIna\Herd\laravel11\resources\views/posts.blade.php ENDPATH**/ ?>
  ...
  <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
      <article class="mx-auto w-full max-w-4xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
          <header class="mb-4 lg:mb-6 not-format">
            <a href="/posts" class="font-meduium text-xs text-blue-600 hover:underline">&laquo; Back to all posts</a>
                  ...
                  <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                      ...
                      <div>
                          ...
                          <a href="/posts?category=<?php echo e($post->category->slug); ?>">
                            <span class="bg-<?php echo e($post->category->color); ?>-100 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded
...
<?php endif; ?>
<?php /**PATH C:\Users\BIna\Herd\laravel11\resources\views/post.blade.php ENDPATH**/ ?>